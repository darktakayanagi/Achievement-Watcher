...
function translateUI(lang, locale, template) {
  ...
  selector.find("li:nth-child(1) .right select option[value='true']").text(clear(template.settings.common.enable));
  selector.find("li:nth-child(1) .right select option[value='false']").text(clear(template.settings.common.disable));
  selector.find('li:nth-child(1) .help').text(clear(template.settings.souvenir.option.screenshot.description));
  selector.find('li:nth-child(2) .left span').text(clear(template.settings.souvenir.option.overwrite.name));
  selector.find("li:nth-child(2) .right select option[value='true']").text(clear(template.settings.common.enable));
  selector.find("li:nth-child(2) .right select option[value='false']").text(clear(template.settings.common.disable));
  $('#custom_dir_screenshot div.left span').text(clear(template.settings.souvenir.option.custom_dir.name));
  $('#custom_dir_screenshot div.btn span').text(clear(template.settings.common.edit));
  selector = $('#options-souvenir-video');
  selector.prev('.title').find('span').text(clear(template.settings.souvenir.title.video));
  selector.find('li:nth-child(1) .left span').text(clear(template.settings.souvenir.option.video.name));
  selector.find("li:nth-child(1) .right select option[value='0']").text(clear(template.settings.common.disable));
  selector.find('li:nth-child(1) .help').text(clear(template.settings.souvenir.option.video.description));
  selector.find('li:nth-child(2) .left span').text(clear(template.settings.souvenir.option.codec.name));
  selector.find('li:nth-child(2) .help').text(clear(template.settings.souvenir.option.codec.description));
  selector.find('li:nth-child(3) .left span').text(clear(template.settings.souvenir.option.colorDepth.name));
  selector.find('li:nth-child(3) .help').text(clear(template.settings.souvenir.option.colorDepth.description));
  selector.find('li:nth-child(4) .left span').text(clear(template.settings.souvenir.option.duration.name));
  selector.find('li:nth-child(5) .left span').text(clear(template.settings.souvenir.option.framerate.name));
  selector.find('li:nth-child(6) .left span').text(clear(template.settings.souvenir.option.cursor.name));
  selector.find("li:nth-child(6) .right select option[value='true']").text(clear(template.settings.common.enable));
  selector.find("li:nth-child(6) .right select option[value='false']").text(clear(template.settings.common.disable));
  selector.find('li:nth-child(7) .left span').text(clear(template.settings.souvenir.option.overwrite.name));
  ...
  $('#custom_dir_video div.left span').text(clear(template.settings.souvenir.option.custom_dir.name));
  $('#custom_dir_video div.btn span').text(clear(template.settings.common.edit));
